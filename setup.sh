...
CONFIG_DIRS=("fuzzel" "i3blocks" "kitty" "sway" "alacritty" "eza" "git" "ptpython" "yazi" "tmux" "swaync" "tealdeer" "helix" "macchina" "waybar" "mako" "starship" "xdg-desktop-portal-wlr" "imv" "zathura" "mpv" "satty")
